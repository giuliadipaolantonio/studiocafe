...
<?php
  ...
  if($connessione){  
    ...
    $tel = $_POST['inputTel'];
    $pane = $_POST['tipoPane'];
    $verdura = $_POST['inputVerdure'];
    $formaggio = $_POST['inputFormaggio'];
    $affettato = $_POST['inputAffettato'];
    ...
    if(mysqli_query($connessione,
            "INSERT INTO panini(email, pane, verdura, affettato, formaggio, data, ora, sede) 
            VALUES('$email','$pane', '$verdura', '$affettato', '$formaggio', '$data', '$orario', '$sede')")){ ?>
        ...
        <div class="card-body">
          ...
          <h6 class="card-subsub"> <b>Registrati</b> o <b>accedi</b> per vedere tutte le ordinazioni <br>
           effettuate con la tua email!</h6>
            ...
            echo "<b>Tipo Pane</b>: $pane<br>";
            echo "<b>Composizione</b>: $verdura, $formaggio, $affettato <br>";
          ...
          <a href='../panino.html' class="btn btn-lg btn-light">Ordina ancora</a>
        </div>
    ...
    <div class="page w-auto h-auto" id="home">    
      <div class="card text-center mb-3">
        ...
        <div class="card-body">          
          ...
          <a href='../panino.html'  class="btn btn-lg btn-light">Torna indietro</a>
        </div>
        <div class="card-footer text-muted">
